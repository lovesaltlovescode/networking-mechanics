...
public class CustomNetworkManager : NetworkManager
{
    ...
    [SerializeField] private GameObject VR_Canvas = null;
    ...
    public override void OnServerAddPlayer(NetworkConnection conn)
    {
        ...
        if (SceneManager.GetActiveScene().path == menuScene)
        {
            ...
            if (isLeader)
            {
                roomPlayerInstance.gameObject.transform.GetChild(1).GetChild(0).SetParent(VR_Canvas.transform);
            }
    ...
    public void StartGame()
    {
        ...
        if (SceneManager.GetActiveScene().path == menuScene)
        {
           ...
           // Debug.Log("Network Manager Custom: Starting game...");
            ...
            //Change Scene
            ServerChangeScene("Scene_Map_Shop_CrossPlatform");
