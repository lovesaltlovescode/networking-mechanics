...
public class VR_OrderManagement_Old : MonoBehaviour
{
    private static VR_OrderManagement_Old _instance;
    public static VR_OrderManagement_Old Instance { get { return _instance; } }
    private void Awake()
    {
        #region Singleton
