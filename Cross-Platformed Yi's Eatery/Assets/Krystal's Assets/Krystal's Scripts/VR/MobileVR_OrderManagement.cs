...
public class MobileVR_OrderManagement : MonoBehaviour
{
    #region Singleton

    private static MobileVR_OrderManagement _instance;
    public static MobileVR_OrderManagement Instance { get { return _instance; } }
